...
//                   className="flex items-center gap-2 bg-(--color-primary) text-(--color-primary-content) px-3 py-2 rounded text-sm"
//                 >
//                   <MdEdit />
//                   Edit
//                 </button>
...
//                   }
//                   className="flex items-center gap-2 border border-(--color-primary) text-(--color-primary) px-3 py-2 rounded text-sm hover:bg-(--color-primary) hover:text-(--color-primary-content)"
//                 >
//                   <MdOutlineLockReset />
//                   Change Password
//                 </button>
...
//                   disabled={isLoading}
//                   className="bg-(--color-primary) text-(--color-primary-content) px-4 py-2 rounded text-sm"
//                 >
...
//               <div className="w-36 h-36 rounded-full overflow-hidden border-2 border-(--color-primary)">
//                 <img
//                   src={
//                     profilePicPreview ||
//                     user?.photo?.url ||
...
//               {editingProfile && (
//                 <div
//                   className="absolute bottom-1 right-1 bg-(--color-base-100) border rounded-full p-2 shadow cursor-pointer"
//                   title="Change Photo"
//                 >
//                   <label
//                     htmlFor="profilePic"
...
//                   disabled
//                   className="col-span-4 px-3 py-2 border border-transparent rounded bg-(--color-base-100) text-(--color-secondary)"
//                 />
